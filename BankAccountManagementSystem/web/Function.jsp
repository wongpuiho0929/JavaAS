<%-- 
    Document   : Function
    Created on : 2016/2/28, 下午 08:49:06
    Author     : user
--%>
...
<html>
    <head>
        ...
        <link href="css/function_page_style.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <div id="wrap">
            ...
            <nav id="mainnav">
                ...
                <h1 id="textlogo">
                    Bank Account<span> Management System</span>
                </h1>
                <ul>
        ...
        <footer>
            ...
            <div id="credits">
                2012 &copy; All Rights Reserved. IVE</div>
        </footer>
    </body>
</html>
